...
export const ArrowDown = ({ size = 20 }) => (
...
export const ArrowUp = ({ size = 20 }) => (
  <svg {...iconProps} width={size} height={size}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 20V4m0 0 6 6m-6-6-6 6" />
  </svg>
)
...
export const RefreshCw = ({ size = 20 }) => (
  <svg {...iconProps} width={size} height={size}>
...
export const MoreHorizontal = ({ size = 20 }) => (
  <svg {...iconProps} width={size} height={size}>
...
export const ArrowUpDown = ({ size = 20 }) => (
  <svg {...iconProps} width={size} height={size}>
...
export const Share = ({ size = 18 }) => (
  <svg {...iconProps} width={size} height={size}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 1 0 0 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186 9.566-5.314m-9.566 7.5 9.566 5.314m0 0a2.25 2.25 0 1 0 3.935 2.186 2.25 2.25 0 0 0-3.935-2.186Zm0-12.814a2.25 2.25 0 1 0 3.933-2.185 2.25 2.25 0 0 0-3.933 2.185Z" />
  </svg>
)

export const AlertCircle = ({ size = 20, style }) => (
...
export const ZecLogo = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <circle cx="20" cy="20" r="20" fill="#F4B728"/>
    <path d="M10 13h20v3L15.5 27H30v3H10v-3l14.5-11H10v-3Z" fill="white"/>
  </svg>
)
